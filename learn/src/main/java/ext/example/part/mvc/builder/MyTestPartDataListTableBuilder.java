...
import ext.example.part.mvc.tableview.PartsDataTableBuilderConfigurableView;
 ...
 * @author 段鑫扬
 */
@ComponentBuilder("ext.example.part.mvc.builder.MyTestPartDataListTableBuilder")
public class MyTestPartDataListTableBuilder extends AbstractConfigurableTableBuilder {

    private static final String CLASSNAME = MyTestPartDataListTableBuilder.class.getName();
...
//        table.addComponent(factory.newColumnConfig(DescriptorConstants.ColumnIdentifiers.STATE,true));
    ...
    public ConfigurableTable buildConfigurableTable(String s) throws WTException {
        return new PartsDataTableBuilderConfigurableView();
    }
}
