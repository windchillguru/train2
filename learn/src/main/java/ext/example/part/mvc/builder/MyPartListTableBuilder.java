 ...
 * @author 段鑫扬
 */
@ComponentBuilder("ext.example.part.mvc.builder.MyPartListTableBuilder")
public class MyPartListTableBuilder extends AbstractConfigurableTableBuilder {

    private static final String CLASSNAME = MyPartListTableBuilder.class.getName();
    ...
    public ComponentConfig buildComponentConfig(ComponentParams componentParams) throws WTException {
        ...
        //表头
        table.setLabel(message.getMessage(tableResource.TABLE_LABEL));
        //是否可选
