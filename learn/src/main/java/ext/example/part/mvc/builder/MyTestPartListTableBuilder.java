 ...
 * @author 段鑫扬
 */
@ComponentBuilder("ext.example.part.mvc.builder.MyTestPartListTableBuilder")
public class MyTestPartListTableBuilder extends AbstractConfigurableTableBuilder {

    private static final String CLASSNAME = MyTestPartListTableBuilder.class.getName();
