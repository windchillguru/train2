 ...
 * @author 段鑫扬
 */
public class FindWTDocumentDependencyLinkByRoleA {
    /**
     ...
     */
    public static WTCollection findWTDocumentDependencyLinkByRoleA(String oid) throws WTException, PropertyVetoException {
