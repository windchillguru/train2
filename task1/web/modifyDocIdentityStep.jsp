...
<%@ taglib uri="http://www.ptc.com/windchill/taglib/mvc" prefix="mvc" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@page import="ext.task.doc.util.ModifyDocIdentityUtil,java.util.*" %>
<fmt:setLocale value="${localeBean.locale}"/>
<fmt:setBundle basename="ext.task.doc.resource.docAPIResource"/>
<fmt:message var="NEW_NUMBER" key="MODIFY_DOCIDENTITY_NUMBER"/>
<fmt:message var="NEW_NAME" key="MODIFY_DOCIDENTITY_NAME"/>
<fmt:message var="MODIFY_DOCIDENTITY_ERR1" key="MODIFY_DOCIDENTITY_ERR1"/>
<%
  Map<String, String> partInfoMap = ModifyDocIdentityUtil.initPartParams(commandBean);
